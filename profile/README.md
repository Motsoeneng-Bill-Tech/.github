...
| **mb-anchor-games** · `JavaScript` | Active | 2 active / 2 total | 3d ago | MB Leaderboard and Anchor Games counting down to the convention. |
| **Organization Profile & Telemetry** | Active | 1 active / 2 total ⚠️ | 4d ago | This repository — organization profile, health files, and the engineering telemetry pipeline that generates this page. |
| **mb-invoicing-tool** · `Java` | Active | 2 active / 2 total | 5d ago | Decodes glyph-obfuscated legal invoice PDFs, reconciles every fee line to the cent, auto-categorises by learned rules, and exports the team's Excel analysis. Multi-matter. |
| **anchor-games** · `TypeScript` | Active | 1 active / 1 total ⚠️ | 10d ago | MB Leaderboard and Anchor Games  counting down to the convention. |
| **mb-wills-week** · `JavaScript` | Active | 1 active / 1 total ⚠️ | 13d ago | _No description set yet._ |
| **MB Knowledge Vault Enterprise** · `JavaScript` | Maintenance | 0 active / 1 total ⛔ | 18d ago | Centralized institutional knowledge repository, precedent search engine, and automated compliance policy cross-referencing. |
| **MB 67 Minutes** · `JavaScript` | Dormant | 0 active / 2 total | 67d ago | Community outreach and pro-bono engagement initiative supporting the firm's public-good programs. |
...
| **07** | [<img src="https://avatars.githubusercontent.com/u/318985580?v=4" width="30" height="30" style="border-radius:50%; vertical-align:middle;" /> **@TheoSingo**](https://github.com/TheoSingo) <br/>[↗ profile](https://motsoeneng-bill-tech.github.io/.github/#/member/TheoSingo) | **Dormant** | **5%** <br/>`1/19 days` | **0d** <br/>`1d best` | 10% <br/>`25% corroborated` | **1** active <br/>`2 total` | <img src="https://cdn.jsdelivr.net/gh/Motsoeneng-Bill-Tech/.github@main/assets/graphs/TheoSingo.svg?v=4" width="220" height="64" alt="TheoSingo activity calendar" /> |
...
| | |
| :--- | :--- |
| **Verified presence** | **97%** of the last 30 days (29 of 30) · 77 verified days in total |
| **Verified streak** | **26 days** current · 51 days best |
| **Recorded activity** | 100% of the last 30 days per GitHub's calendar · **92%** of it independently corroborated |
| **Trend** | Steady — 7.0 active days/week recently vs 6.7 before |
| **Projects** | **6** active of 6 worked on |
| **Technologies** | `Java`, `Python`, `TypeScript` |

| | Project | Days engaged | Span | Position |
| :---: | :--- | :---: | :---: | :--- |
| ▸ | **Forensics Due Diligence System** | 47 | `Aug 03, 2026 → Sep 21, 2026` | Active — last worked 0d ago · **sole active engineer** |
| ▸ | **Tender Intelligence Platform** | 38 | `Jul 02, 2026 → Sep 19, 2026` | Active — last worked 2d ago |
| ▸ | **MB-IQ-Revamped** | 7 | `Sep 04, 2026 → Sep 21, 2026` | Active — last worked 0d ago · **sole active engineer** |
| ▸ | **Job Portal** | 5 | `Jul 25, 2026 → Sep 19, 2026` | Active — last worked 2d ago · **sole active engineer** |
| ▸ | **Organization Profile & Telemetry** | 4 | `Jun 24, 2026 → Sep 17, 2026` | Active — last worked 4d ago · **sole active engineer** |
| ▸ | **mb-invoicing-tool** | 3 | `Sep 11, 2026 → Sep 16, 2026` | Active — last worked 5d ago |
...
| | |
| :--- | :--- |
| **Verified presence** | **87%** of the last 30 days (26 of 30) · 48 verified days in total |
| **Verified streak** | **22 days** current · 22 days best |
...
| | Project | Days engaged | Span | Position |
| :---: | :--- | :---: | :---: | :--- |
| ▸ | **Enterprise Case Management** | 27 | `Jul 22, 2026 → Sep 21, 2026` | Active — last worked 0d ago |
| · | **MB Knowledge Vault Enterprise** | 19 | `Aug 07, 2026 → Sep 03, 2026` | Last active 18d ago |
| · | **MB 67 Minutes** | 6 | `Jul 09, 2026 → Jul 16, 2026` | Last active 67d ago |
| ▸ | **mb-wills-week** | 6 | `Sep 03, 2026 → Sep 08, 2026` | Active — last worked 13d ago · **sole active engineer** |
| · | **Forensics Due Diligence System** | 5 | `Aug 07, 2026 → Aug 14, 2026` | Last active 38d ago |
...
| | |
| :--- | :--- |
| **Verified presence** | **80%** of the last 30 days (24 of 30) · 59 verified days in total |
...
| **Trend** | Improving — 6.5 active days/week recently vs 5.0 before |
| **Projects** | **2** active of 3 worked on |
| **Technologies** | `JavaScript`, `Python` |

| | Project | Days engaged | Span | Position |
| :---: | :--- | :---: | :---: | :--- |
| ▸ | **Tender Intelligence Platform** | 38 | `Jul 03, 2026 → Sep 21, 2026` | Active — last worked 0d ago |
| · | **Forensics Due Diligence System** | 24 | `Aug 07, 2026 → Sep 06, 2026` | Last active 15d ago |
| ▸ | **mb-anchor-games** | 4 | `Sep 15, 2026 → Sep 18, 2026` | Active — last worked 3d ago |
...
| **Trend** | Improving — 3.8 active days/week recently vs 2.3 before |
| **Projects** | **2** active of 2 worked on |
| **Technologies** | `Java` |

| | Project | Days engaged | Span | Position |
| :---: | :--- | :---: | :---: | :--- |
| ▸ | **Enterprise Case Management** | 27 | `Jul 13, 2026 → Sep 17, 2026` | Active — last worked 4d ago |
| ▸ | **mb-invoicing-tool** | 5 | `Aug 31, 2026 → Sep 16, 2026` | Active — last worked 5d ago |
...
| | |
| :--- | :--- |
| **Verified presence** | **27%** of the last 30 days (8 of 30) · 12 verified days in total |
| **Verified streak** | **1 days** current · 3 days best |
| **Recorded activity** | 30% of the last 30 days per GitHub's calendar · **80%** of it independently corroborated |
| **Trend** | Improving — 1.8 active days/week recently vs 0.8 before |
| **Projects** | **1** active of 1 worked on |
| **Technologies** | `Java` |

| | Project | Days engaged | Span | Position |
| :---: | :--- | :---: | :---: | :--- |
| ▸ | **Enterprise Case Management** | 9 | `Aug 31, 2026 → Sep 21, 2026` | Active — last worked 0d ago |
...
| | Project | Days engaged | Span | Position |
| :---: | :--- | :---: | :---: | :--- |
| ▸ | **Enterprise Case Management** | 14 | `Jul 23, 2026 → Sep 13, 2026` | Active — last worked 8d ago |
| ▸ | **mb-anchor-games** | 5 | `Sep 12, 2026 → Sep 16, 2026` | Active — last worked 5d ago |
| · | **MB 67 Minutes** | 4 | `Jul 10, 2026 → Jul 13, 2026` | Last active 70d ago |
| · | **Forensics Due Diligence System** | 1 | `Aug 06, 2026 → Aug 06, 2026` | Last active 46d ago |
...
<img src="https://avatars.githubusercontent.com/u/318985580?v=4" width="40" height="40" style="border-radius:50%; vertical-align:middle;" /> [`@TheoSingo`](https://github.com/TheoSingo) · first seen here Sep 03, 2026 · Last commit 10 days ago

> **Continuity risk:** currently the only active engineer on **anchor-games**. Worth a second pair of hands.

| | |
| :--- | :--- |
| **Verified presence** | **5%** of the last 19 days (1 of 19) · 1 verified days in total |
...
| | Project | Days engaged | Span | Position |
| :---: | :--- | :---: | :---: | :--- |
| · | **Organization Profile & Telemetry** | 2 | `Sep 03, 2026 → Sep 04, 2026` | Last active 17d ago |
| ▸ | **anchor-games** | 1 | `Sep 11, 2026 → Sep 11, 2026` | Active — last worked 10d ago · **sole active engineer** |
...
<!-- TIMESTAMP:START -->
 *Last synced: 2026-09-21 16:03 UTC* 
<!-- TIMESTAMP:END -->
